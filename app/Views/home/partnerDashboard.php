            ...
            <div class="card-stats">
                <div class="card-stats-title">Order Statistics -
                    <div class="dropdown d-inline">
                        ...
                        <ul class="dropdown-menu dropdown-menu-sm" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 15px, 0px);">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
            <div class="card-chart">
                ...
                <canvas id="balance-chart" height="80" width="337" style="display: block;" class="chartjs-render-monitor"></canvas>
            </div>
            <div class="card-icon shadow-primary bg-primary">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
            <div class="card-chart">
                ...
                <canvas id="sales-chart" height="80" width="337" style="display: block;" class="chartjs-render-monitor"></canvas>
            </div>
            <div class="card-icon shadow-primary bg-primary">
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <canvas id="myChart" height="333" style="display: block; width: 634px; height: 333px;" width="634" class="chartjs-render-monitor"></canvas>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
            ...
            <div class="card-body">
                <div class="owl-carousel owl-theme owl-loaded owl-drag" id="products-carousel">
                    ...
                    <div class="owl-stage-outer">
                        <div class="owl-stage" style="transform: translate3d(-620px, 0px, 0px); transition: all 0.25s ease 0s; width: 1397px;">
                            <div class="owl-item cloned" style="width: 145.167px; margin-right: 10px;">
                                <div>
                            ...
                            <div class="owl-item" style="width: 145.167px; margin-right: 10px;">
                                <div>
                                    <div class="product-item pb-3">
                                        <div class="product-image">
                                            <img alt="image" src="../assets/img/products/product-4-50.png" class="img-fluid">
                            ...
                            <div class="owl-item active" style="width: 145.167px; margin-right: 10px;">
                                <div>
                                    <div class="product-item">
                                        <div class="product-image">
                                            <img alt="image" src="../assets/img/products/product-3-50.png" class="img-fluid">
                            ...
                            <div class="owl-item cloned active" style="width: 145.167px; margin-right: 10px;">
                                <div>
                                    <div class="product-item pb-3">
                                        <div class="product-image">
                                            <img alt="image" src="../assets/img/products/product-4-50.png" class="img-fluid">
...
<script src=" /assets/page/partnerDashboard.js"></script>
<?= $this->endSection() ?>