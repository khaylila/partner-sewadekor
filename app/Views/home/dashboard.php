...
<head>
    ...
    <title>Dashboard &mdash; Partner Panel sewadekor.id</title>
        ...
        <div class="main-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="/admin/add">Tambah Admin</a></li>
                                <li><a class="nav-link" href="/admin">Daftar Admin</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="card gradient-bottom">
                                ...
                                <div class="card-body" id="top-5-scroll">
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="/assets/stisla/assets/img/products/product-3-50.png" alt="product">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="/assets/stisla/assets/img/products/product-4-50.png" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="/assets/stisla/assets/img/products/product-1-50.png" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded" width="55" src="/assets/stisla/assets/img/products/product-5-50.png" alt="product">
                                            <div class="media-body">
                                                <div class="float-right">
                                    ...
                                    <div class="owl-carousel owl-theme" id="products-carousel">
                                        <div>
                                            <div class="product-item pb-3">
                                                <div class="product-image">
                                                    <img alt="image" src="/assets/stisla/assets/img/products/product-4-50.png" class="img-fluid">
                                                </div>
                                        ...
                                        <div>
                                            <div class="product-item">
                                                <div class="product-image">
                                                    <img alt="image" src="/assets/stisla/assets/img/products/product-3-50.png" class="img-fluid">
                                                </div>
                                                <div class="product-details">
                                        ...
                                        <div>
                                            <div class="product-item">
                                                <div class="product-image">
                                                    <img alt="image" src="/assets/stisla/assets/img/products/product-1-50.png" class="img-fluid">
                                                </div>
                                                <div class="product-details">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="/assets/stisla/node_modules/flag-icon-css/flags/4x3/id.svg" alt="image" width="40">
                                                ...
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="/assets/stisla/node_modules/flag-icon-css/flags/4x3/my.svg" alt="image" width="40">
                                                    <div class="media-body ml-3">
                                                ...
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="/assets/stisla/node_modules/flag-icon-css/flags/4x3/us.svg" alt="image" width="40">
                                                    <div class="media-body ml-3">
                                        ...
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                                                ...
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="/assets/stisla/node_modules/flag-icon-css/flags/4x3/ps.svg" alt="image" width="40">
                                                    <div class="media-body ml-3">
                                                ...
                                                <li class="media">
                                                    <img class="img-fluid mt-1 img-shadow" src="/assets/stisla/node_modules/flag-icon-css/flags/4x3/de.svg" alt="image" width="40">
                                                    <div class="media-body ml-3">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> Design By <a href="https://www.instagram.com/roiyan_r/">Mochamad Roiyan Rintiarno</a>
                </div>
